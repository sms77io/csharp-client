...
namespace Sms77.Api.Tests {
    ...
    public class Status {
        ...
        private void AssertStatus(Library.Status.Status status) {
        ...
        public async Task Retrieve() {
            ...
            Library.Status.Status status = Library.Status.Status.FromString(response);
        ...
        public async Task RetrieveJson() {
            Library.Status.Status status = await BaseTest.Client.Status(_statusParams, true);
